...
const STYLES = {
  primary: {
    needsPseudo: false,
    all: 'text-white uppercase font-semibold sm:font-bold bg-gradient-to-r from-green-600 via-green-700 to-green-500 bg-200% hover:animate-bg-shift px-4 py-2',
  },
  secondary: {
    needsPseudo: true,
    all: 'text-white uppercase font-semibold sm:font-bold group px-4 py-2 relative',
    main: 'relative z-50',
    before: 'absolute bg-gradient-to-r from-green-600 to-green-900 top-0 left-0 w-full h-full z-10',
...
<template>
  <component
:is="componentToRender" :type="to ? undefined : 'button'" :class="selectedLook.all" :to="to"
    class="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 inline-block">
